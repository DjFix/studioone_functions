...
**How To Use:**</br>
Copy it to the same folder as your script files and add **_include_file('functions.js')_** to the top of your JS code file.

_Right click the link below and **Save As...** to download:_>/br> 
